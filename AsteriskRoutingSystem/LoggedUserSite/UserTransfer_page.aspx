...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <asp:dropdownlist id="DropDownList_from" runat="server" datasourceid="ObjectDataSource2" appenddatabounditems="True" datatextfield="name_Asterisk" 
        datavaluefield="name_Asterisk" onselectedindexchanged="DropDownList_from_SelectedIndexChanged" autopostback="True" validationgroup="transfer_validation">   
        <Items>
